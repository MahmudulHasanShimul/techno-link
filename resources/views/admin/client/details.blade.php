...
<div class="row mt-3">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Client's Detail Information</h4>
            <hr>
            ...
            <div class="table-responsive m-t-40">
                <table id="myTable" class="table table-striped border">
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($client->status == 'Active')
                                <p class="card-text" style="color: green; font-weight:bold">Active</p>
                            @else
                    ...
                    <tr>
                        <th>Action</th>
                        <td style ="width:"80px">
                            <a href="{{route('client.edit',['id'=>$client->id])}}" class="btn btn-success" title="Edit">Edit</a>
                            <a href="{{route('client.manage')}}" class="btn btn-primary m-1" title="Back">Back</a>
                        </td>
                    </tr>
                </table>
            </div>
